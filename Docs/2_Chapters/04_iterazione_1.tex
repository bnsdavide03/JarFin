...
Il microservizio implementa un'architettura a strati rigorosa (\textit{Layered Architecture}) per garantire la separazione delle responsabilità (\textit{Separation of Concerns}). Il flusso dei dati attraversa i seguenti layer:
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{../Iterazione_1/images/postman_post.png}
