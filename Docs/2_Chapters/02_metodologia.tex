...
Questa scelta architetturale consente di avviare il servizio di persistenza in modo rapido e indipendente dalla configurazione del sistema operativo ospite, evitando installazioni locali invasive e garantendo un ambiente sempre pulito e riproducibile.
...
La qualità strutturale del codice è stata analizzata mediante \textbf{SonarLint}, strumento di analisi statica integrato nell'ambiente di sviluppo per applicazioni Java. SonarLint è stato utilizzato per:
\begin{itemize}
    \item rilevare metriche di complessità cognitiva e ciclomatica;
    \item individuare \textit{code smells}, bug potenziali e vulnerabilità di sicurezza;
    \item supportare la verifica del rispetto dei principi di Clean Code e delle convenzioni di programmazione.
\end{itemize}

L’analisi statica ha contribuito a mantenere un’architettura pulita, riducendo il debito tecnico e garantendo la manutenibilità del sistema nel lungo periodo.
